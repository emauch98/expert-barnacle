...
# Sonde and Pond is efectively the same
# take m1
...
# Step 4: How is Chlorophyll RFU related to Chlorophyll mg/L ? -----------------
...
# Treatment and Chlorophyll_RFU values in terms of Chlorophyll ug/L:
