...
fwrite(bayesian.merge, "../results_metabolism/ERL85_bayesian_2022.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of ERL85 in 2022"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_ERL85_2022.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond ERL85 in 2022"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_ERL85_2022.png", width = 1200, height = 900)
print(fig4)
dev.off()
