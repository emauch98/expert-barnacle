...
k600.vachon <- k.vachon(all.600, lake.area = 5000) # Area from the LakeMaster file
...
################################################################################
# The max depth of pond B2P2 is about 3m.
# According to the profiling plots, B2P2 had an actively mixed layer depth of
# at least 2m on June 19, 2022.
# Since mixed layer depth is highly dependent on weather, I'll asssume an
# average mixed layer depth of 2m
################################################################################

# Set Actively mixed layer depth to 2m
all$z.mix <- 2
...
fwrite(bayesian.merge, "../results_metabolism/B2P2_bayesian_2022.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B2P2 in 2022"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B2P2_2022.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond B2P2 in 2022"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_B2P2_2022.png", width = 1200, height = 900)
print(fig4)
dev.off()
