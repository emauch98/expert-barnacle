################################################################################
# This is a metabolism analysis of pond B3P3 in 2023
# Treatment B3P3: Fish (Sticklebacks), 1 source
...
# Make a timeseries object
ts2 <- ts(all$wtr, frequency = 288)

# Impute with imputeTS: DO
...
sum(is.na(imp_all2)) # No missing values anymore
...
k600.vachon <- k.vachon(all.600, lake.area = 3000) # From LakeMaster file
...
fwrite(bayesian.merge, "../results_metabolism/B3P3_bayesian_2023.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B3P3 in 2023"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B3P3_2023.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond B3P3 in 2023"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_B3P3_2023.png", width = 1200, height = 900)
print(fig4)
dev.off()
