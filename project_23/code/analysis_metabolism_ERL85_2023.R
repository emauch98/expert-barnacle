################################################################################
# This is a metabolism analysis of pond ERL85 in 2023
...
# Since acitvely mixed layer depth is highly dependent on water,
# I'll assume an aversage actively mixed layer depth of 2m over the whole
# observation period
################################################################################
...
fwrite(bayesian.merge, "../results_metabolism/ERL85_bayesian_2023.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of ERL85 in 2023"))
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond ERL85 in 2023"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_ERL85_2023.png", width = 1200, height = 900)
print(fig4)
dev.off()
