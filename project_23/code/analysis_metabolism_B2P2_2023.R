################################################################################
# This is a metabolism analysis of pond B2P2 in 2023
# Treatment B2P2: Fish (Sticklebacks), 1 source
...
fwrite(bayesian.merge, "../results_metabolism/B2P2_bayesian_2023.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B2P2 in 2023"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B2P2_2023.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond B2P2 in 2023"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_B2P2_2023.png", width = 1200, height = 900)
print(fig4)
dev.off()
