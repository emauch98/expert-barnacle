################################################################################
# This is a metabolism analysis of pond B3P2 in 2023
# Treatment B3P2: Fish (Sticklebacks), 2 sources
...
k600.vachon <- k.vachon(all.600, lake.area = 5300) # From LakeMaster file
...
# According to the profiling plots, B3P2 more or less fully stratified on
# June  20 2022
...
fwrite(bayesian.merge, "../results_metabolism/B3P2_bayesian_2023.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B3P2 in 2023"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B3P2_2023.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond B3P2 in 2023"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_B3P2_2023.png", width = 1200, height = 900)
print(fig4)
dev.off()
