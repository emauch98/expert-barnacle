################################################################################
# This is a metabolism analysis of Pond B3P3 in 2021
# Treatment B3P3: Fish (Sticklebacks)
#
...
# only about 1.5m on Sept 13 2021
...
fwrite(bayesian.merge, "../results_metabolism/B3P3_bayesian_2021.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B3P3 in 2021"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B3P3_2021.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond B3P3 in 2021"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_B3P3_2021.png", width = 1200, height = 900)
print(fig4)
dev.off()
