################################################################################
# This is a metabolism analysis of Pond ERL152 in 2021
# Treatment ERL152: Control (no fish)
#
# This analysis is made in the context of the Stickleback-experiments by Blake's
# group in Greenland 2021.
#
# Aim of this sript: model ecosystem metabolism of ERL152. The whole workflow is
# described in the report "report_analysis_metabolism_B3P3_2022",
# which serves as a blueprint for this analysis.
#
# Observation period used to estimate metabolism of ERL152:
...
k600.vachon <- k.vachon(all.600, lake.area = 7300)
...
################################################################################
# The max depth of pond ERL152 is about 4.5m.
# According to the profiling plots, ERL152 was very stratified on Sept 16, 2021
...
fwrite(bayesian.merge, "../results_metabolism/ERL152_bayesian_2021.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of ERL152 in 2021"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_ERL152_2021.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond ERL152 in 2021"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_ERL152_2021.png", width = 1200, height = 900)
print(fig4)
dev.off()
