################################################################################
# This is a metabolism analysis of Pond B3P0 in 2021
# Treatment B3P0 : Control (no fish)
#
# This analysis is made in the context of the Stickleback-experiments by Blake's
# group in Greenland 2021.
#
# Aim of this sript: model ecosystem metabolism of B3P0. The whole workflow is
...
k600.vachon <- k.vachon(all.600, lake.area = 8100)
...
################################################################################
# The max depth of pond B3P0 is about 4m.
# According to the profiling plots, B3P0 had an actively mixed layer depth of
# about 2.9m on Sept13 2021
# Since mixed layer depth is highly dependent on weather, I will assume an
# average mixed layer depth of 2m over the whole period
################################################################################
...
fwrite(bayesian.merge, "../results_metabolism/B3P0_bayesian_2021.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B3P0 in 2021"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B3P0_2021.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond B3P0 in 2021"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_B3P0_2021.png", width = 1200, height = 900)
print(fig4)
dev.off()
