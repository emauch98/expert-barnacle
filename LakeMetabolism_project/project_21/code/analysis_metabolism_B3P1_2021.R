################################################################################
# This is a metabolism analysis of Pond B3P1 in 2021
...
#
# Aim of this sript: model ecosystem metabolism of B3P1. The whole workflow is
...
# Ommit last rows ofmetadata and sonde datasets
...
# at least 1.5m on Sept15 2021
# Since mixed layer depth is highly dependent on weather, I will assume an
# average mixed layer depth of 1.5 m over the whole period
################################################################################
...
fwrite(bayesian.merge, "../results_metabolism/B3P1_bayesian_2021.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B3P1 in 2021"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B3P1_2021.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond B3P1 in 2021"))

# Save the plot as a .png
png("../results_metabolism/metabolism_B3P1_2021.png", width = 1200, height = 900)
print(fig4)
dev.off()
