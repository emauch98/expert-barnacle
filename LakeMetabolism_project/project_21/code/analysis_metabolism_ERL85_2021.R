################################################################################
# This is a metabolism analysis of Pond ERL85 in 2021
# Treatment ERL85: Control (no fish)
#
# This analysis is made in the context of the Stickleback-experiments by Blake's
# group in Greenland 2021.
#
# Aim of this sript: model ecosystem metabolism of ERL85. The whole workflow is
...
# According to the profiling plots, ERL85 had an actively mixed layer depth of
# less than 1m on Sept 21 2021 (very stratified)
...
fwrite(bayesian.merge, "../results_metabolism/ERL85_bayesian_2021.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of ERL85 in 2021"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_ERL85_2021.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond ERL85 in 2021"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_ERL85_2021.png", width = 1200, height = 900)
print(fig4)
dev.off()
