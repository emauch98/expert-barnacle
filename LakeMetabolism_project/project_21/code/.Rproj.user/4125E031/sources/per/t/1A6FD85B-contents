...
sonde_key = fread( "../data/sondes_key_2021.txt", header=T)

# step 1: merge all raw data files into a single big one -----------------------

path = "../data/raw_data_sondes/Raw_sonde_2021_preprocessed"
...
fwrite(complete, "../data/processed_data_sondes/sonde_data_completeness_2021.txt", sep="\t")
# Some major datagaps for B1P1!
...
png("../../Presentations/control_DO_2021.png", width = 1600, height = 1000)
