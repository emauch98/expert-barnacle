...
B3P3 <- fread("../results_metabolism/B3P3_bayesian_2021.txt")
B1P1 <- fread("../results_metabolism/B1P1_bayesian_2021.txt")
B2P2 <- fread("../results_metabolism/B2P2_bayesian_2021.txt")
B2P3 <- fread("../results_metabolism/B2P3_bayesian_2021.txt")
B3P1 <- fread("../results_metabolism/B3P1_bayesian_2021.txt")
B3P2 <- fread("../results_metabolism/B3P2_bayesian_2021.txt")

# Treatment: no Fish
B2P4 <- fread("../results_metabolism/B2P4_bayesian_2021.txt")
ERL85 <- fread("../results_metabolism/ERL85_bayesian_2021.txt")
B3P0 <- fread("../results_metabolism/B3P0_bayesian_2021.txt")
ERL152 <- fread("../results_metabolism/ERL152_bayesian_2021.txt")
ERL122 <- fread("../results_metabolism/ERL122_bayesian_2021.txt")
B1P4 <- fread("../results_metabolism/B1P4_bayesian_2021.txt")
...
# Merge
all <- rbind(B1P1, B2P2, B3P3, B2P3, B3P1, B3P2, B1P4, B2P4, B3P0, ERL85, ERL122, ERL152)

# Save
fwrite(all, "../results_metabolism/merged_results_complete_2021.txt", sep = "\t")
# ------------------------------------------------------------------------------

# Treatment and Pond as factor
...
p1 = ggplot(subset(all, Pond=="B1P1"), aes(y=GPP, x=Date, color = Treatment)) + theme_light() +
  ...
  # No Fish
  geom_line(data = subset(all, Pond=="B2P4"), aes(y=GPP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="B2P4"), aes(ymin = GPP-GPPsd, ymax = GPP+GPPsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="ERL85"), aes(y=GPP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="ERL85"), aes(ymin = GPP-GPPsd, ymax = GPP+GPPsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="B3P0"), aes(y=GPP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="B3P0"), aes(ymin = GPP-GPPsd, ymax = GPP+GPPsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="ERL152"), aes(y=GPP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="ERL152"), aes(ymin = GPP-GPPsd, ymax = GPP+GPPsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="ERL122"), aes(y=GPP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="ERL122"), aes(ymin = GPP-GPPsd, ymax = GPP+GPPsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="B1P4"), aes(y=GPP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="B1P4"), aes(ymin = GPP-GPPsd, ymax = GPP+GPPsd), width = 0.15) +
  
  ylab(expression(paste("GPP (", O[2], " in mg L", NULL^-1, " day", NULL^-1, ")"))) +
  ggtitle("Modeled GPP of all Ponds in 2021") +
  theme_minimal()

plot(p1)

# Save the plot as a .png
png("../results_metabolism/GPP_complete_2021.png", width = 1600, height = 1000)
print(p1)
dev.off()
...
p2 = ggplot(subset(all, Pond=="B1P1"), aes(y=R, x=Date, color = Treatment)) + theme_light() +
  ...
  # No Fish
  geom_line(data = subset(all, Pond=="B2P4"), aes(y=R, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="B2P4"), aes(ymin = R-Rsd, ymax = R+Rsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="ERL85"), aes(y=R, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="ERL85"), aes(ymin = R-Rsd, ymax = R+Rsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="B3P0"), aes(y=R, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="B3P0"), aes(ymin = R-Rsd, ymax = R+Rsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="ERL152"), aes(y=R, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="ERL152"), aes(ymin = R-Rsd, ymax = R+Rsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="ERL122"), aes(y=R, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="ERL122"), aes(ymin = R-Rsd, ymax = R+Rsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="B1P4"), aes(y=R, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="B1P4"), aes(ymin = R-Rsd, ymax = R+Rsd), width = 0.15) +
  ylab(expression(paste("R (", O[2], " in mg L", NULL^-1, " day", NULL^-1, ")"))) +
  ggtitle("Modeled R of all Ponds in 2021") +
  theme_minimal()

plot(p2)

# Save the plot as a .png
png("../results_metabolism/R_complete_2021.png", width = 1600, height = 1000)
print(p2)
dev.off()
...
p3 = ggplot(subset(all, Pond=="B1P1"), aes(y=NEP, x=Date, color = Treatment)) + theme_light() +
  ...
  # No Fish
  geom_line(data = subset(all, Pond=="B2P4"), aes(y=NEP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="B2P4"), aes(ymin = NEP-NEPsd, ymax = NEP+NEPsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="ERL85"), aes(y=NEP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="ERL85"), aes(ymin = NEP-NEPsd, ymax = NEP+NEPsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="B3P0"), aes(y=NEP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="B3P0"), aes(ymin = NEP-NEPsd, ymax = NEP+NEPsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="ERL152"), aes(y=NEP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="ERL152"), aes(ymin = NEP-NEPsd, ymax = NEP+NEPsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="ERL122"), aes(y=NEP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="ERL122"), aes(ymin = NEP-NEPsd, ymax = NEP+NEPsd), width = 0.15) +
  
  geom_line(data = subset(all, Pond=="B1P4"), aes(y=NEP, x=Date, color = Treatment),lwd = 1.1, alpha = 0.3) +
  geom_errorbar(data = subset(all, Pond=="B1P4"), aes(ymin = NEP-NEPsd, ymax = NEP+NEPsd), width = 0.15) +
  ylab(expression(paste("NEP (", O[2], " in mg L", NULL^-1, " day", NULL^-1, ")"))) +
  ggtitle("Modeled NEP of all Ponds in 2021") +
  theme_minimal()

plot(p3)

# Save the plot as a .png
png("../results_metabolism/NEP_complete_2021.png", width = 1600, height = 1000)
print(p3)
dev.off()
...
# save
fwrite(daily_means, "../results_metabolism/merged_results_daily_mean_complete_2021.txt", sep = "\t")
...
p4 = ggplot(data = daily_means, aes(x = Date, y = mean_GPP, color = Treatment)) +
  ...
  ggtitle("Mean GPP across all ponds and treatments in 2021")

plot(p4)

# Save the plot as a .png
png("../results_metabolism/GPP_daily_means_complete_2021.png", width = 1600, height = 1000)
print(p4)
dev.off()
...
p5 = ggplot(data = daily_means, aes(x = Date, y = mean_R, color = Treatment)) +
  ...
  ggtitle("Mean R across all ponds and treatments in 2021")

plot(p5)

# Save the plot as a .png
png("../results_metabolism/R_daily_means_complete_2021.png", width = 1600, height = 1000)
print(p5)
dev.off()
...
p6 = ggplot(data = daily_means, aes(x = Date, y = mean_NEP, color = Treatment)) +
  ...
  ggtitle("Mean NEP across all ponds and treatments in 2021")

plot(p6)

# Save the plot as a .png
png("../results_metabolism/NEP_daily_means_complete_2021.png", width = 1600, height = 1000)
print(p6)
dev.off()
