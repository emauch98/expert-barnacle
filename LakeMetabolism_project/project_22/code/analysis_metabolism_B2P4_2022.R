################################################################################
# This is a metabolism analysis of pond B2P4
# Treatment B2P4: no Fish
# Observation period used to estimate metabolism of B2P4:
...
fwrite(bayesian.merge, "../results_metabolism/B2P4_bayesian_2022.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B2P4 in 2022"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B2P4_2022.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond B2P4 in 2022"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_B2P4_2022.png", width = 1200, height = 900)
print(fig4)
dev.off()
