################################################################################
# This is a metabolism analysis of pond B3P2
# Treatment B3P2: Fish (Sticklebacks)
# Observation period used to estimate metabolism of B3P2:
# 2022-06-24 00:00:00 to 2022-07-03 00:00:00
# After that, the Sonde 13 probably went out of battery
# Model used: Bayesian
################################################################################
...
fwrite(bayesian.merge, "../results_metabolism/B3P2_bayesian_2022.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B3P2 in 2022"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B3P2_2022.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
# Save the plot as a .png
png("../results_metabolism/metabolism_B3P2_2022.png", width = 1200, height = 900)
print(fig4)
dev.off()
