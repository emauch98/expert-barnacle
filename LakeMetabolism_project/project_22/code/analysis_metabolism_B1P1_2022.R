################################################################################
# This is a metabolism analysis of pond B1P1 in 2022
# For 2022, we chose to fit the maximum number of days for any given Pond (instead
# of the maximum shared days among all ponds),
# since we did not have access to the same amount of data compared to other years
...
fwrite(bayesian.merge, "../results_metabolism/B1P1_bayesian_2022.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B1P1 in 2022"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B1P1_2022.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond B1P1 in 2022"))

plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_B1P1_2022.png", width = 1200, height = 900)
print(fig4)
dev.off()
