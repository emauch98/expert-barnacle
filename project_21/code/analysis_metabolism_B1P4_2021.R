################################################################################
# This is a metabolism analysis of Pond B1P4 in 2021
# Treatment B1P4: Control (no fish)
#
# This analysis is made in the context of the Stickleback-experiments by Blake's
# group in Greenland 2021.
#
# Aim of this sript: model ecosystem metabolism of B1P4. The whole workflow is
# described in the report "report_analysis_metabolism_B3P3_2022",
# which serves as a blueprint for this analysis.
#
# Observation period used to estimate metabolism of B1P4:
...
k600.vachon <- k.vachon(all.600, lake.area = 4400)
...
################################################################################
# The max depth of pond B1P4 is about 2m.
# According to the profiling plots, B1P4 had an actively mixed layer depth of
# at least 1.5m on Sept 11 2021.
################################################################################
...
fwrite(bayesian.merge, "../results_metabolism/B1P4_bayesian_2021.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B1P4 in 2021"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B1P4_2021.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond B1P4 in 2021"))

plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_B1P4_2021.png", width = 1200, height = 900)
print(fig4)
dev.off()
