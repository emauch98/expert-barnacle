################################################################################
# This is a metabolism analysis of Pond ERL122 in 2021
# Treatment ERL122: Control (no fish)
#
# This analysis is made in the context of the Stickleback-experiments by Blake's
# group in Greenland 2021.
#
# Aim of this sript: model ecosystem metabolism of ERL122. The whole workflow is
# described in the report "report_analysis_metabolism_B3P3_2022",
# which serves as a blueprint for this analysis.
#
# Observation period used to estimate metabolism of ERL122:
# 2021-09-19 00:00:00 to 2021-09-24 00:00:00
# There is a data-gap on 2021-09-18 of a few hours
# I chose to estimate metabolism after this data-gap, 5 consecutive days
#
...
fwrite(bayesian.merge, "../results_metabolism/ERL122_bayesian_2021.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of ERL122 in 2021"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_ERL122_2021.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond ERL122 in 2021"))
plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_ERL122_2021.png", width = 1200, height = 900)
print(fig4)
dev.off()
