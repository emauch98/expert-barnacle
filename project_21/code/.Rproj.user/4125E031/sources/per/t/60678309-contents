...
# 2-3 meters, if a pond has a max depth of 5 meters, I am going to take 2m 
# for the average actively mixed layer depth.
...
fwrite(bayesian.merge, "../results_metabolism/B1P1_bayesian_2021.txt", sep="\t")
...
fig3 <- annotate_figure(fig2, top = text_grob("Parameters used to estimate metabolism of B1P1 in 2021"))

plot(fig3)

# Save the plot as a .png
png("../results_metabolism/parameters_B1P1_2021.png", width = 1200, height = 900)
print(fig3)
dev.off()
...
fig4 <- annotate_figure(fig1, top = text_grob("Estimated metabolism of pond B1P1 in 2021"))

plot(fig4)

# Save the plot as a .png
png("../results_metabolism/metabolism_B1P1_2021.png", width = 1200, height = 900)
print(fig4)
dev.off()
